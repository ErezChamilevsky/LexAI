...
export const ChatMessage = ({ msg, languageCode = 'en-US' }) => {
    ...
    return (
        <div className={clsx(
            ...
            <div className={clsx(
                "group relative p-3 md:p-4 shadow-sm backdrop-blur-sm text-sm leading-relaxed overflow-hidden",
                msg.sender === 'user'
                ...
                {msg.sender === 'assistant' && (
                    <button
                        ...
                        className={clsx(
                            ...
                            isSpeaking
                                ? "bg-pink-100 text-pink-500 animate-pulse"
